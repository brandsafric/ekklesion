 ...
 */
final class Version20181105145145 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE person ADD membership_is_member TINYINT(1) NOT NULL, ADD membership_became_member_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:chronos)\', ADD membership_is_deacon TINYINT(1) NOT NULL, ADD membership_became_deacon_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:chronos)\', ADD membership_is_elder TINYINT(1) NOT NULL, ADD membership_became_elder_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:chronos)\', DROP role_value, CHANGE gender gender VARCHAR(255) NOT NULL, CHANGE avatar avatar VARCHAR(255) DEFAULT NULL, CHANGE facebook facebook VARCHAR(255) DEFAULT NULL, CHANGE email_primary email_primary VARCHAR(255) DEFAULT NULL, CHANGE email_secondary email_secondary VARCHAR(255) DEFAULT NULL, CHANGE phone_primary phone_primary VARCHAR(255) DEFAULT NULL, CHANGE phone_secondary phone_secondary VARCHAR(255) DEFAULT NULL');
    }
