 ...
 */
final class Version20181031221633 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE person (uuid CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', avatar VARCHAR(255) DEFAULT NULL, account_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', first_visit DATETIME DEFAULT NULL COMMENT \'(DC2Type:chronos)\', baptized_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:chronos)\', added_at DATETIME NOT NULL COMMENT \'(DC2Type:chronos)\', name_given LONGTEXT NOT NULL COMMENT \'(DC2Type:simple_array)\', name_father VARCHAR(255) NOT NULL, name_mother VARCHAR(255) DEFAULT NULL, role_value INT NOT NULL, PRIMARY KEY(uuid)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
    }
